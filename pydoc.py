# Embedded file name: /home/boris/undernetbot/build/run/out00-PYZ.pyz/pydoc
...
def render_doc(thing, title = 'Python Library Documentation: %s', forceload = 0):
    ...
    if type(object) is _OLD_INSTANCE_TYPE:
        ...
        object = inspect.isclass(object) or inspect.isroutine(object) or inspect.isgetsetdescriptor(object) or inspect.ismemberdescriptor(object) or isinstance(object, property) or type(object)
        desc += ' object'
        ...
        for importer, modname, ispkg in pkgutil.walk_packages(onerror=onerror):
            ...
            if key is None:
                ...
                if hasattr(loader, 'get_source'):
                    import StringIO
                    if not source_synopsis(StringIO.StringIO(loader.get_source(modname))):
                        desc = ''
                    ...
                    find(lower(modname + ' - ' + desc), key) >= 0 and callback(path, modname, desc)
