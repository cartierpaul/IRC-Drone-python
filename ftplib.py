# Embedded file name: /home/boris/undernetbot/build/run/out00-PYZ.pyz/ftplib
...
class Netrc():
    ...
    def __init__(self, filename = None):
        ...
        while 1:
            ...
            if default:
                if not user:
                    self.__defuser = self.__defuser
                    if not passwd:
                        self.__defpasswd = self.__defpasswd
                        self.__defacct = acct or self.__defacct
                    ouser, opasswd, oacct = host and host in self.__hosts and self.__hosts[host]
                    user = user or ouser
