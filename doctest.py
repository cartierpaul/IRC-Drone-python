# Embedded file name: /home/boris/undernetbot/build/run/out00-PYZ.pyz/doctest
...
if not getattr(sys.__stdout__, 'encoding', None):
    _encoding = 'utf-8'
    ...
    __name__ == '__main__' and sys.exit(_test())